...
function Jewelry(){
    ...
    useEffect(() => {
        apiRequest.get(`https://4ilk3v7wbk.execute-api.eu-west-1.amazonaws.com/dev/collections/266329161801/products.json`)
            .then((res) => {
    ...
    return(
        <>
          {/*  <div className={'ml-4'}>
                <PageHeading title={'Jewelry'}/>
            </div>
            <div className={'font-semibold flex justify-start items-start uppercase ml-8 mt-4'}>
                <div className={'w-16 h-[2px] bg-yellow-400 mr-8 mb-12'}>Introducing our exquisite Jewelry Collection</div>
            </div>*/}
